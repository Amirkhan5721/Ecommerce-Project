import BnrImg from "../../assets/BnrImg.jpg";
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 items-center'>
                    ...
                    <div className='flex flex-col justify-center gap-6 sm:pt-0'>
                        <h1 data-aos="fade-up"
                            ...
                            Winter Sala upto 50% off
                        </h1>
                        <p data-autosave="fade-up"
                            className='text-sm text-gray-500 tracking-wide leading-5'>
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea,
                            blanditiis! Minus dolorem dolor soluta aliquam ea, laboriosam ullam earum repellendus cum beatae,
                            dolores voluptates neque in commodi aspernatur ipsam vel similique quaerat?
                        </p>
